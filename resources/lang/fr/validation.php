...
return [
    ...
    'custom' => [
        ...
        'images' => [
            ...
            'min' => 'Vous devez ajouter au moins :min image(s).',
        ],
        'checkin_date' => [
            'after' => 'La date d\'arrivée doit être dans le futur.',
        ],
        'checkout_date' => [
            'after' => 'La date de départ doit être après la date d\'arrivée.',
        ],
    ],
    ...
    'attributes' => [
        ...
        'min_rental_duration' => 'durée minimale de location',
        'max_rental_duration' => 'durée maximale de location',
        ...
        'infants_count' => 'nombre de bébés',
        'purpose_of_trip' => 'objet du voyage',
        'guest_details' => 'détails du voyageur',
        'email' => 'email',
